                ...
                <div className="flex items-center gap-5 mx-10">
                    <section className="w-1/2 space-y-10">
                        ...
                        <p className="text-xl text-gray-200">
                            Our goal is to provide affordable, accessible, and high-quality courses to empower learners worldwide and help them build industry-relevant technical skills.                        </p>
                    </section>
                    <div className="w-1/2">
